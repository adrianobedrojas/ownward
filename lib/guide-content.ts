...
const baseGuideArticles: GuideArticle[] = [
  ...
  },
  {
    ...
    category: "sell",
    title: "How to Prepare Your Business for Sale: A Practical Readiness Guide",
    cardTitle: "How to Prepare Your Business for Sale",
    description:
    ...
    readingTime: "12 min read",
    metadataDescription:
      "A practical guide to preparing a small business for sale, including financial cleanup, owner dependence, due diligence documents, confidentiality, valuation readiness, buyer qualification, and a 30-day action plan.",
    introduction: [
    ...
    sections: [
      {
        title: "1. Define what a successful sale means to you",
        paragraphs: [
      ...
      {
        title: "2. Make the business easier to understand",
        paragraphs: [
      ...
      {
        title: "3. Organize and review the financial records",
        paragraphs: [
      ...
      {
        title: "4. Separate normal operations from owner-specific expenses",
        paragraphs: [
      ...
      {
        title: "5. Reduce excessive dependence on the owner",
        paragraphs: [
      ...
      {
        title: "6. Identify risks before a buyer discovers them",
        paragraphs: [
      ...
      {
        title: "7. Build a due diligence document index",
        paragraphs: [
      ...
      {
        title: "8. Protect confidentiality through staged disclosure",
        paragraphs: [
        ...
        steps: [
          "Publish a limited anonymous or confidential summary",
          "Ask the interested buyer for basic acquisition criteria",
          "Confirm identity and contact information",
          "Determine whether the buyer has a plausible source of funds",
          "Use an appropriate confidentiality agreement",
          "Share a more detailed business summary",
          "Release sensitive records gradually as interest becomes credible",
          "Restrict highly sensitive information until advanced due diligence",
        ],
      },
      {
        title: "9. Develop a supportable valuation range",
        paragraphs: [
      ...
      {
        title: "10. Qualify buyers before providing extensive access",
        paragraphs: [
      ...
      {
        title: "11. Prepare for negotiation, diligence, and closing",
        paragraphs: [
    ...
    actionPlan: [
      {
        week: "Week 1",
        focus:
          "Define your sale objectives, write a clear business overview, and identify the most important risks that could concern a buyer.",
      },
      {
        week: "Week 2",
        focus:
          "Review financial records, document owner-specific expenses, and reconcile major differences between reports and supporting records.",
      },
      {
        week: "Week 3",
        focus:
          "Create a due diligence document index, organize files securely, and begin documenting procedures that currently depend on the owner.",
      },
      {
        week: "Week 4",
        focus:
          "Develop a confidential disclosure process, prepare buyer qualification questions, and discuss valuation, legal, accounting, and tax considerations with qualified professionals.",
      },
    ],
    checklist: [
      "Sale objectives documented",
      "Preferred timeline identified",
      "Business model summarized clearly",
      "Financial statements reviewed",
      "Tax returns and supporting records organized",
      "Owner-specific expenses documented",
      "Outstanding liabilities identified",
      "Customer concentration reviewed",
      "Owner dependence evaluated",
      "Important operating procedures documented",
      "Licenses and contracts reviewed",
      "Due diligence document index created",
      "Sensitive documents separated from public information",
      "Confidentiality process established",
      "Buyer qualification questions prepared",
      "Valuation assumptions documented",
      "Transition expectations considered",
      "Professional legal, accounting, and tax review planned",
    ],
    categoryCtaHref: "/guide/sell",
  ...
  },
  {
    ...
    category: "start" as const,
    title: "How to Start an LLC Without Mistaking Paperwork for a Business",
    cardTitle: "How to Start an LLC",
    description:
    ...
    metadataDescription:
      "Learn how to start an LLC: choose your formation state, appoint a registered agent, file Articles of Organization, draft an operating agreement, obtain an EIN, open a business bank account, and build a compliance calendar to keep the entity in good standing.",
    publishedDate: "August 1, 2026",
    lastReviewed: "August 1, 2026",
    introductionTitle: "The filing creates the entity. The next steps make it operable.",
    contentNotice:
      "This article provides general educational information about forming a U.S. LLC. It is not legal, tax, accounting, or financial advice. Requirements, fees, tax treatment, licenses, and deadlines depend on the state, locality, industry, ownership arrangement, and business activities. Verify every step with official government agencies and qualified professionals.",
    sourceNotice:
    ...
    learningObjectives: [
      "Decide whether an LLC is appropriate before paying a filing fee",
      "Understand the difference between state formation and federal tax classification",
      "Complete the main formation and activation steps in the correct order",
      "Identify state-specific questions that must be verified independently",
      "Build a compliance system that continues after approval",
    ],
    introduction: [
    ...
    sections: [
      {
        title: "1. What an LLC does and does not do",
        paragraphs: [
      ...
      {
        title: "2. Decide whether an LLC fits the business",
        paragraphs: [
      ...
      {
        title: "3. Choose the formation state deliberately",
        paragraphs: [
      ...
      {
        title: "4. Clear the name in four separate systems",
        paragraphs: [
      ...
      {
        title: "5. Decide ownership and control before filing",
        paragraphs: [
      ...
      {
        title: "6. Select a registered agent",
        paragraphs: [
      ...
      {
        title: "7. File the state formation document",
        paragraphs: [
      ...
      {
        title: "Save your approved formation document",
        paragraphs: [
      ...
      {
        title: "8. Create the operating agreement and founding records",
        paragraphs: [
      ...
      {
        title: "Operating agreements for multi-member LLCs",
        paragraphs: [
      ...
      {
        title: "9. Obtain an EIN after state approval",
        paragraphs: [
      ...
      {
        title: "Applicants outside the United States",
        paragraphs: [
      ...
      {
        title: "10. Understand that LLC and tax classification are different decisions",
        paragraphs: [
      ...
      {
        title: "11. Register for taxes, licenses, permits, and insurance",
        paragraphs: [
      ...
      {
        title: "The LLC filing does not grant permission to perform regulated work",
        paragraphs: [
      ...
      {
        title: "12. Activate financial separation",
        paragraphs: [
        ...
        steps: [
          "Receive the approved state formation document confirming the entity exists",
          "Obtain the EIN from the IRS when applicable (required by most banks)",
          "Finalize and sign the operating agreement",
          "Open a dedicated business bank account in the LLC's legal name",
          "Connect any payment processor or merchant account to the business bank account",
          "Establish a bookkeeping system and a process for storing receipts and business records",
          "Sign all contracts using the complete legal name of the LLC, or a properly registered DBA, not your personal name",
        ],
      },
      {
        title: "13. Handle multi-state activity and BOI carefully",
        paragraphs: [
      ...
      {
        title: "14. Build a compliance calendar",
        paragraphs: [
      ...
      {
        title: "15. What 'finished' should look like",
        paragraphs: [
      ...
      {
        title: "The goal is an entity that knows what comes next",
        paragraphs: [
    ...
    checklist: [
      "Confirmed that an LLC fits the business and ownership plan",
      "Chosen the formation state based on real operations",
      "Checked state name availability and searched for trademark conflicts using the USPTO database",
      "Decided ownership percentages and management authority with all owners",
      "Selected an eligible registered agent with a qualifying physical address",
      "Filed through the official state authority and saved the approved formation document",
      "Completed and signed the operating agreement",
      "Obtained an EIN from the IRS and safely stored the confirmation letter when applicable",
      "Registered for applicable state and local taxes",
      "Verified licenses, permits, zoning requirements, and insurance needs",
      "Opened a dedicated business bank account in the LLC's legal name",
      "Established bookkeeping and business document storage",
      "Reviewed foreign-qualification requirements and verified current FinCEN BOI guidance",
      "Created a recurring compliance calendar with all known deadlines",
    ],
    checklistTitle: "LLC formation and activation checklist",
    categoryCtaHref: "/guide/start",
    categoryCtaLabel: "Back to Start a Business",
    ownwardCtaHref: "/start",
    ownwardCtaLabel: "Build your startup plan",
    sources: [
      ...
      {
        label: "SBA — Apply for licenses and permits",
        href: "https://www.sba.gov/business-guide/launch-your-business/apply-licenses-permits",
      },
      {
        label: "SBA — Stay legally compliant",
        href: "https://www.sba.gov/business-guide/manage-your-business/stay-legally-compliant",
      },
      {
        label: "IRS — Limited liability company",
