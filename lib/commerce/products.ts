...
const PRODUCT_REGISTRY: Record<ProductKey, ProductDefinition> = {
  quick_boost: {
    ...
    descriptionEn: "Get a 14-day visibility boost for your public listing.",
    descriptionEs: "Obtén un impulso de visibilidad para tu listado público durante 14 días.",
    outcomeEn: "Give your listing a 14-day visibility boost.",
    outcomeEs: "Dale a tu listado mayor visibilidad durante 14 días.",
  ...
  exit_intelligence_bundle: {
    ...
    descriptionEs:
      "Un centro de inteligencia unificado para valuación, preparación para venta, riesgo de transferencia, perspectiva del comprador y próximos pasos.",
    outcomeEn:
      "Understand what strengthens or weakens your exit position and what to improve next.",
    outcomeEs:
      "Comprende qué fortalece o debilita tu posición de salida y qué mejorar a continuación.",
    category: "business_intelligence",
    audience: ["owner", "seller"],
    goals: ["improve_sale_readiness", "improve_valuation"],
    billingModel: "free",
    ...
    billingContextEs: "Incluido con una cuenta gratuita de Ownward",
    deliverablesEn: [
      "Exit readiness command center",
      "Valuation position and confidence",
      "Buyer perspective summary",
      "Transfer-risk and evidence analysis",
      "Prioritized 30/60/90-day action plan",
    ],
    deliverablesEs: [
      "Centro de comando de preparación para salida",
      "Posición de valuación y confianza",
      "Resumen de perspectiva del comprador",
      "Análisis de riesgo de transferencia y evidencia",
      "Plan de acción priorizado de 30/60/90 días",
    ],
    detailRoute: "/solutions/exit-intelligence-bundle",
    ctaBehavior: "open",
    accessRoute: "/solutions/exit-intelligence-bundle",
    requiresAuth: true,
    requiredTargetType: "business",
    ...
    disclaimersEn: [
      "Planning and educational intelligence only.",
      "Not legal, tax, accounting, brokerage, investment, or certified valuation advice.",
      "Results depend on user-provided information and may be incomplete or outdated.",
      "Ownward does not guarantee sale price, buyer interest, transaction timing, or a successful sale.",
    ],
    disclaimersEs: [
      "Inteligencia de planificación y educativa únicamente.",
      "No es asesoramiento legal, fiscal, contable, de corretaje, de inversión ni una valuación certificada.",
      "Los resultados dependen de la información proporcionada por el usuario y pueden ser incompletos u obsoletos.",
      "Ownward no garantiza precio de venta, interés de compradores, plazos de transacción ni una venta exitosa.",
    ],
    active: true,
    isPublic: true,
  },
  ...
  closing_archive: {
    ...
    nameEn: "Exit Intelligence Profile",
    nameEs: "Perfil de Inteligencia de Salida",
    descriptionEn: "Consolidated intelligence profile for business exit preparation.",
    descriptionEs: "Perfil consolidado de inteligencia para la preparación de salida del negocio.",
    outcomeEn: "Bring valuation, readiness, risk, and transferability insights into one exit view.",
    outcomeEs: "Reúne valoración, preparación, riesgo y transferibilidad en una sola visión de salida.",
    category: "transactions",
  ...
  business_comparison_pack: {
    ...
    nameEn: "Business Comparison",
    nameEs: "Comparación de Negocios",
    descriptionEn: "Compare shortlisted business acquisition opportunities side by side.",
    descriptionEs: "Compara lado a lado oportunidades preseleccionadas de adquisición de negocios.",
    outcomeEn: "Evaluate opportunities using consistent financial, operational, and risk criteria.",
    outcomeEs: "Evalúa oportunidades utilizando criterios consistentes de finanzas, operaciones y riesgo.",
    ...
    billingContextEn: "Free when available",
    billingContextEs: "Gratis cuando esté disponible",
    deliverablesEn: ["Structured business comparison analysis"],
    deliverablesEs: ["Análisis estructurado de comparación de negocios"],
  ...
  essential_intelligence_pack: {
    ...
    descriptionEn: "Future additional-usage credit pack for Ownward intelligence.",
    descriptionEs: "Futuro paquete de créditos para uso adicional de la inteligencia de Ownward.",
    outcomeEn: "Add extra intelligence usage beyond the allowance included with your Ownward account.",
    outcomeEs: "Añade uso adicional de inteligencia más allá de la capacidad incluida con tu cuenta de Ownward.",
    category: "credits",
    ...
    displayPrice: 5,
    status: "planned",
    billingContextEn: "planned one-time usage add-on",
    billingContextEs: "complemento futuro de uso con pago único",
    deliverablesEn: ["Additional intelligence usage credits"],
    deliverablesEs: ["Créditos adicionales de uso de inteligencia"],
    ...
    disclaimersEn: [
  "Planned overage product.",
  "Core Ownward intelligence does not require this pack.",
],
disclaimersEs: [
  "Producto futuro para uso adicional.",
  "La inteligencia principal de Ownward no requiere este paquete.",
],
    active: false,
    isPublic: true,
  },
  enhanced_intelligence_pack: {
    ...
    descriptionEn: "Future higher-capacity usage pack for Ownward intelligence.",
    descriptionEs: "Futuro paquete de mayor capacidad para el uso de la inteligencia de Ownward.",
    outcomeEn: "Add a larger block of intelligence usage for heavier report and analysis needs.",
    outcomeEs: "Añade una mayor capacidad de uso de inteligencia para necesidades más intensivas de reportes y análisis.",
    category: "credits",
    audience: ["owner", "seller", "buyer"],
    goals: ["access_intelligence"],
    billingModel: "one_time",
...
disclaimersEs: [
  ...
  complete_intelligence_pack: {
    ...
    descriptionEn: "Future highest-capacity usage pack for intensive Ownward intelligence needs.",
descriptionEs: "Futuro paquete de máxima capacidad para necesidades intensivas de inteligencia de Ownward.",
outcomeEn: "Add the highest on-demand intelligence capacity for intensive analysis and reporting.",
outcomeEs: "Añade la mayor capacidad de inteligencia bajo demanda para análisis y reportes intensivos.",
    category: "credits",
    audience: ["owner", "seller", "buyer"],
    goals: ["access_intelligence"],
    billingModel: "one_time",
