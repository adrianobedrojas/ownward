        ...
        <div className="mt-10 space-y-10">
          {article.sections.map((section) => (
            <section key={section.title} className="space-y-4">
              ...
              {section.quote ? <blockquote className="my-4 border-l-4 border-cyan-400 py-2 pl-5"><p className="text-base font-medium italic leading-8 text-slate-200 sm:text-lg">“{section.quote}”</p></blockquote> : null}
            </section>
          ))}
        </div>
