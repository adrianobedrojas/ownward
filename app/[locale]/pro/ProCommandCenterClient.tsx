    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 px-4 py-10 max-w-6xl mx-auto">
      ...
      <div className="mb-8 flex items-start justify-between flex-wrap gap-4">
        ...
        <div className="flex gap-3">
          <Link href="/portfolio" className="text-xs px-3 py-2 rounded-lg bg-slate-800 border border-slate-700 text-slate-300 hover:border-slate-500">
            Portfolio →
          </Link>
          <Link href="/seller" className="text-xs px-3 py-2 rounded-lg bg-slate-800 border border-slate-700 text-slate-300 hover:border-slate-500">
            Seller Area →
          </Link>
        </div>
      </div>
