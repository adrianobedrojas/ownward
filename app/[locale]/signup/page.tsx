    ...
    <div className="mx-auto grid min-h-[calc(100vh-73px)] max-w-7xl items-center gap-12 px-4 py-12 sm:px-6 lg:grid-cols-2">
      <section>
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          {accountTypes.map((accountType) => (
            <article key={accountType.title} className="rounded-xl border border-slate-800 bg-slate-900 p-5">
              <h2 className="font-semibold text-white">{accountType.title}</h2>
              <p className="mt-2 text-sm leading-6 text-slate-400">{accountType.description}</p>
            </article>
          ))}
        </div>
      </section>
      ...
      <section className="rounded-2xl border border-slate-800 bg-slate-900 p-6 shadow-2xl shadow-slate-950 sm:p-8">
        ...
        <form action="/api/signup" method="post" className="space-y-6">
          <div>
            <label htmlFor="account-type" className="block text-sm font-semibold text-slate-300">
              {t('accountTypeLabel')}
            </label>
            <select
              id="account-type"
          ...
          <div>
            <label htmlFor="full-name" className="block text-sm font-semibold text-slate-300">
              {forms('fullName')}
            </label>
            <input
              id="full-name"
          ...
          <div>
            <label htmlFor="business-name" className="block text-sm font-semibold text-slate-300">
              {forms('businessName')} <span className="ml-2 font-normal text-slate-500">Optional</span>
            </label>
            <input
              id="business-name"
              name="businessName"
              ...
              placeholder={forms('businessName')}
              className="mt-2 w-full rounded-lg border border-slate-700 bg-slate-950 px-4 py-3 text-white outline-none placeholder:text-slate-600 focus:border-cyan-400"
            />
          </div>
...
>>>>>>> a95f09c (Add optional partner communications consent across signup/onboarding and profiles migration)
