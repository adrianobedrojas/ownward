    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 px-4 py-10 max-w-5xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <a href="/seller/new" className="text-xs bg-cyan-500 hover:bg-cyan-400 text-slate-950 px-3 py-2 rounded-lg font-semibold">
            + New Opportunity
          </a>
        </div>
        ...
        {businessOpps.length === 0 ? (
          <div className="rounded-xl border border-slate-700 bg-slate-900 p-8 text-center text-slate-400">
            ...
            <a href="/seller/new" className="text-cyan-400 hover:underline">Create your first one.</a>
          </div>
        ) : (
